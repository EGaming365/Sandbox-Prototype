# Floor item for the wooden pickaxe.
...
func _ready():
	visible = false
	z_index = 2
	# Show the pickaxe picture on the sprite.
	$Sprite2D.texture = pickaxe_texture
